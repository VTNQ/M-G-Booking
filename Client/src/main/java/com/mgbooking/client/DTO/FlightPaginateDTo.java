...
public class FlightPaginateDTo {
    private int id;
    ...
    public FlightPaginateDTo(int id, String nameAirline, String departure_airport, String arrival_airport, Instant departure_time, Instant arrival_time) {
        this.id = id;

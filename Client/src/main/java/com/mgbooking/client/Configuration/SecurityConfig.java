...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .requestMatchers("/Login","/Home","/css/**","/js/**","/user/**","/SuperAdmin/assets/**","/images/**","/LoginAdmin","/Profile","/Flight","/Hotel","/RegisterUser",
                ...
                .requestMatchers("/Owner","/Owner/Profile","/Owner/UpdateProfile","/Owner/Hotel/add","Owner/Hotel","Owner/Hotel/{id}","/Owner/Hotel/update").hasRole("OWNER")
                ...
                ,"/Admin/City/add","/Admin/AirPort/add","/Admin/Flight/add").hasRole("ADMIN")// Allow anyone to access /Home

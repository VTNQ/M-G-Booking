...
public interface HotelRepository extends JpaRepository<Hotel, Integer> {
    ...
    @Query("select new com.mgbooking.server.DTOS.Hotel.HotelUpdateDTO(a.id,a.name,a.address,a.cityId,a.decription,a.ownerId,a.district.id) from Hotel a where a.id = :id")
